    ...
    <nav id="header" class="fixed w-full z-30 top-0 text-white">
        <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
            ...
            <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden mt-2 lg:mt-0 bg-white lg:bg-transparent text-black p-4 lg:p-0 z-20" id="nav-content">
                ...
                <ul class="list-reset lg:flex justify-end flex-1 items-center">
                    @if (Route::has('login'))
                            <li class="mr-3">
                                <a class="inline-block py-2 px-4 text-black font-bold no-underline" href="{{ url('/') }}">Accueil</a>
                            </li>
                        @auth
                        <li class="mr-3">
        ...
        <div class="pt-24">
            <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
                ...
                <div class="flex flex-col w-full md:w-2/5 justify-center items-center text-center md:text-left">
                    <p class="uppercase tracking-loose w-full">The first social network strongly inspired by Instagram, created by a student at Webstart Paris!</p>
                    <h1 class="my-4 text-5xl font-bold leading-tight">
                        Inspiration is a shared thing !
                    </h1>
                    <p class="leading-normal text-2xl mb-8">
                        Don’t stay locked up and confined in your home without doing anything! Share your emotions and what you do !
                    </p>
                ...
                <div class="flex flex-wrap">
                    <div class="w-5/6 sm:w-1/2 p-6">
                        <h3 class="text-3xl text-gray-800 font-bold leading-none mb-3">
                            Book a flight or apartment
                        </h3>
                        <p class="text-gray-600 mb-8">
                            Indeed, we do not offer to book a flight or an apartment.
                            <br />
                            <br />

                            Free advertising on my website :
                            <a class="text-pink-500 underline" href="https://bokertov-agency.com/">BokerTov Agency</a>
                        </p>
                    </div>
                ...
                <div class="flex flex-wrap flex-col-reverse sm:flex-row">
                    ...
                    <div class="w-full sm:w-1/2 p-6 mt-6">
                        <div class="align-middle">
                            ...
                            <p class="text-gray-600 mb-8">
                                Of course, myInsta is only used to send messages.
                                <br />
                                <br />
                                Free advertising on my friend’s website:
                                <a class="text-pink-500 underline" href="https://bokertov-agency.com/">BokerTov Agency</a>
                            </p>
                        </div>
                    </div>
        ...
        <section class="bg-white border-b py-8">
            <div class="container mx-auto flex flex-wrap pt-4 pb-12">
                <h1 class="w-full my-2 text-5xl font-bold leading-tight text-center text-gray-800">
                    Some opinions that do not exist
                </h1>
                <div class="w-full mb-4">
                    <div class="h-1 mx-auto gradient w-64 opacity-25 my-0 py-0 rounded-t"></div>
                </div>
